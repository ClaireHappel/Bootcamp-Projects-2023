(function(){
  ...
  QUnit.test( "Our First Test", function( assert ) {
    ...
    //change second value to hello tests ┌ Change this to what it should be
    assert.equal( value, 'hello tests');
    //change second val to 484  ┌ Change this to what it should be
  ...
  QUnit.test("Functions can access/modify variables in parent scope.", function(assert){
    ...
    function yay(){
      ...
      outside_the_function = inside_the_function; //outside the function points to a copy of can you see me
    }

    yay();
    //change second val to can you see me?
